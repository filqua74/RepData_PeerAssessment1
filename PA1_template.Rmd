...
This Rmarkdown document contains the solution for Peer Assessment 1 project.  
...
hist(tmp$step,breaks=10, col="yellow", xlab = "Steps", main="Histogram of total steps per day")
```
